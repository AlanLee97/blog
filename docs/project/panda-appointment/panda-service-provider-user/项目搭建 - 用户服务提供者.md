...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <artifactId>panda-service-provider-user</artifactId>
    <version>1.0.0-SNAPSHOT</version>
    ...
    <dependencies>
        ...
        <dependency>
            <groupId>top.alanlee</groupId>
            <artifactId>panda-common-provider</artifactId>
    ...
    <build>
        <plugins>
            ...
            <plugin>
                ...
                <configuration>
                    <mainClass>top.alanlee.panda.service.provider.user.UserServiceProviderApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
